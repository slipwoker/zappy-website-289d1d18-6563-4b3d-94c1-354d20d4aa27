    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רכבי יוקרה שלכם משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '289d1d18-6563-4b3d-94c1-354d20d4aa27',
                    name: data.name || '',
                    email: data.email || '',
